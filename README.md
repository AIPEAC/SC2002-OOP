...
- How to use:
  - **Download**
    - Download empty-database version for a fresh start of the program. [[Downlaod Link]](https://github.com/AIPEAC/SC2002-OOP/releases/download/Release-v1/Release-v1.1.zip)
    - Download presentation version to present directly. [[Downlaod Link]](https://github.com/AIPEAC/SC2002-OOP/releases/download/Presentation_v3/Presentation-v3.3.zip)
  - **Run the Program**
